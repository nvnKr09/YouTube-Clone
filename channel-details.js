...
const API_key = `AIzaSyBxaTKQuc0-uRvUzoo2wPlWN61dMgOAnec`;
...
async function getSubscription() {
  const endPoint = `https://youtube.googleapis.com/youtube/v3/subscriptions?part=snippet&channelId=UCICCRin36xb0GeF4FoDpGBg&key=${API_key}&maxResults=20`;
  try {
